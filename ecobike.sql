...
INSERT INTO `bike` (`ID`, `Name`, `LicensePlate`, `Status`) VALUES
('b00001', 'xe dap thong nhat', '29-123.45', 'free'),
...
INSERT INTO `parking` (`ID`, `Name`, `Address`, `Area`, `MaxHost`) VALUES
('p00001', 'Bai xe Bach Khoa', 'so 1 Ta Quang Buu, Bach Khoa, Hai Ba Trung, Ha Noi', 200, 15),
...
INSERT INTO `place` (`ParkingID`, `BikeID`, `HostNumber`) VALUES
('p00001', 'b00001', 1),
('p00001', 'b00002', 7),
('p00001', 'b00003', 2),
('p00001', 'b00004', 3),
...
INSERT INTO `standardbike` (`ID`) VALUES
('b00001'),
('b00003'),
('b00004'),
('b00006'),
...
INSERT INTO `standardebike` (`ID`, `Battery`) VALUES
('b00023', 80),
('b00029', 85),
('b00032', 90),
('b00036', 91),
...
INSERT INTO `twinbike` (`ID`) VALUES
('b00002'),
('b00005'),
('b00008'),
('b00011'),
...
('u00001', 'luong thi tam', 'tam tam xinh dep', '12345678'),
...
ALTER TABLE `paymenttransaction`
  ...
  ADD KEY `FK_PaymentTransaction_1` (`BikeID`);
...
ALTER TABLE `rentbike` CHANGE `ID` `ID` INT NOT NULL AUTO_INCREMENT;
ALTER TABLE `paymenttransaction` CHANGE `ID` `ID` INT NOT NULL AUTO_INCREMENT;
...
ALTER TABLE `paymenttransaction`
  ...
  ADD CONSTRAINT `FK_PaymentTransaction_1` FOREIGN KEY (`BikeID`) REFERENCES `bike` (`ID`);
